...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        console.log('Aplicación inicializada correctamente con IndexedDB');
    } catch (error) {
        console.error('Error al inicializar la aplicación:', error);
        UIUtils.showAlert('Error al inicializar la aplicación. Revise la consola para más detalles.', 'danger');
    }
});